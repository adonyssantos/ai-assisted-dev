...
2. **Choose the programming language and target `projects/<name>/`** (Article IV — agnostic; pick by fit, not habit) and justify it. New project → note its stack for a `projects/<name>/AGENTS.md`.
