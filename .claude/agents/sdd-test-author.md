...
1. Read the feature's `spec.md` (acceptance criteria + `FR-XX`), `plan.md` (chosen language, target `projects/<name>/`, test strategy), the project's `AGENTS.md` and `.claude/rules/documentation.md`.
...
5. Do NOT implement the feature. Do NOT weaken tests. Update the test cards on `docs/board.md` to In Progress / Done-for-tests as appropriate.
