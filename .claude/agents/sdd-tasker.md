...
4. If the active tracker is Jira or GitHub Projects, create the items via the configured CLI/MCP per `docs/task-tracking.md` instead of editing the board, keeping the `FR-XX` + `NNN-slug` references.
