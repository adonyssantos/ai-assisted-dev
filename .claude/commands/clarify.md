...
2. Apply the answers to `spec.md`: remove resolved `[NEEDS CLARIFICATION]`, make requirements verifiable, refresh `last_updated`, keep wikilinks (per the documentation rule).
